    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-3 px-5 py-4 border-b border-white/5">
                <div className="w-8 h-8 rounded bg-[#1a1a1e] flex items-center justify-center text-[#c8f135]">
                    ⚖
                </div>
                <div>
                    <p className="text-sm font-black tracking-wide text-white">THE JUDGE'S VERDICT</p>
                    <p className="text-[9px] font-bold tracking-[0.2em] text-[#c8f135] uppercase">Neural Evaluation Protocol Alpha-01</p>
                </div>
            </div>
